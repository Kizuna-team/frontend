...
<template>
  <section class="relative w-full h-screen overflow-hidden">
    <!-- 背景影片 -->
    <video id="hero-video" class="absolute inset-0 z-0 object-cover w-full h-full" autoplay muted loop playsinline
      src="/hero.mp4" type="video/mp4"></video>

    <!-- 漸層遮罩 -->
    <div class="absolute inset-0 bg-gradient-to-r from-black to-black/40 z-[1] opacity-100 animate-fade-in delay-300">
    </div>
    ...
    <div
      ...
      <p class="mb-8 text-xl leading-relaxed opacity-0 md:text-2xl drop-shadow-sm animate-fade-in-delay">
        ...
        <button type="button"
          ...
          <!-- 底色滑動層 -->
          <span
            class="absolute inset-0 bg-[#fb8500] translate-y-full transition-transform duration-500 ease-in-out rounded-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100"></span>
        </button>
    </div>
  </section>
</template>
